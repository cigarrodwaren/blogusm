    ...
    <div class="container mx-auto py-8 mt-8 bg-white shadow-lg rounded-lg">
                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="bg-gray-100 dark:bg-gray-800">
                            ...
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-600 uppercase">{{ __('Slug') }}</th>
        ...
        <div class="text-center">
            <x-nav-link :href="route('tag.create')" :active="request()->routeIs('tag')">
                <span class="inline-block bg-gray-200 rounded-full px-6 py-2 text-sm font-semibold text-gray-700 mr-2 mb-2">{{__('New Tag')}}</span>
            </x-nav-link>
        </div>
    </div>
</x-app-layout>
