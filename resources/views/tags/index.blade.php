<x-app-layout>
    ...
    <div class="container mx-auto py-8 mt-8 bg-white shadow-lg rounded-lg">
       ...
       <div class="text-right">
            <x-nav-link :href="route('tag.create')" :active="request()->routeIs('tags')">
                <span class="inline-block bg-gray-200 rounded-full px-6 py-2 text-sm font-semibold text-gray-700 mr-2 mb-2">{{__('New Tags')}}</span>
            </x-nav-link>
        </div>
    </div>
</x-app-layout>