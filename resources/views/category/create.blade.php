                ...
                <div class="p-6 space-y-6">
                    ...
                    <form action="{{ route('category.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name_cat" id="name_cat" value="{{old('name_cat')}}" class="mt-1 block w-full px-3 py-2 border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required autocomplete="name_cat" placeholder="{{__('Enter category name...')}}">
                            <x-input-error :messages="$errors->get('name_cat')" class="mt-2" />
                        </div>
